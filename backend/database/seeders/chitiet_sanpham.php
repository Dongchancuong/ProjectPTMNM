...
class chitiet_sanpham extends Seeder
{
    public function run()
    {
        DB::table('chitiet_sanpham')->insert([ 
            ...
            'anh' => '', 'created_at' => date("Y-m-d H:i:s")],
            ...
            'anh' => '', 'created_at' => date("Y-m-d H:i:s")],
            ['idsanpham' => 'SNDV27P1', 'idthuonghieu' => 'SEIKO', 'idmau' => 'DEN', 'idloaimay' => 'QUARTZ', 'idchatlieu' => 'CRYSTAL', 
            'gioitinh' => 'Nữ', 'xuatxu' => 'Nhật Bản', 
            'mota' => 'Mẫu Seiko SNDV27P1 phiên bản kim chỉ tone màu tím thời trang nổi bật trên mặt số size 37mm với thiết kế 6 kim tính năng Chronograph đo thời gian.', 
            'anh' => '', 'created_at' => date("Y-m-d H:i:s")],
