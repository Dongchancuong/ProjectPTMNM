...
class ctkm extends Seeder
{
    public function run()
    {
        DB::table('ctkm')->insert([ 
            ['idkhuyenmai' => 'ORDER_HALLO01', 'tenchuongtrinh' => 'Ưu đãi mùa Halloween', 'giamgia' => 30, 'mota' => 'Áp dụng cho các đơn hàng từ 5 triệu trở lên', 'ngaybatdau' => '2022-10-24', 'ngayketthuc' => '2022-10-31', 'created_at' => date("Y-m-d H:i:s")],
